...
Today, there are over 882 million pieces of CC-licensed (or CC0) content on the internet. Roughly 56% of that content is shared under a tool that allows both adaptations and commercial use (we commonly refer to those as free culture licenses).
...
9 million web domains include at least some Creative Commons-licensed content.
...
One major win for open policy is the Trade Adjustment Assistance Community College and Career Training initiative (TAACCCT), run by the US Department of Labor in coordination with the Department of Education, a multi-year, four-billion-dollar project to help community colleges equip their students with the skills they need to find employment. This is the largest such grant in the world to require that all resources be licensed under CC BY.
...
Although CC licenses continue to grow, the technology infrastructure must fundamentally change in order to make both CC licenses and CC-licensed materials truly accessible to everyone.
...
Moving the needle on open policy
